...
public class ListaCircularOrdenada<X extends Comparable<X>> implements Cloneable {
    ...
    public void guarde(X i) throws Exception {
        ...
        if (primeiro == null || primeiro.getInfo().compareTo(i) > 0) {
            ...
            No atual = primeiro;
            while (atual.getProx() != primeiro && atual.getProx().getInfo().compareTo(i) < 0) {
                atual = atual.getProx();
            }
    ...
    public boolean equals(Object obj) {
        ...
        No atualDoObj = ((ListaCircularOrdenada<X>) obj).primeiro;
    ...
    public ListaCircularOrdenada(ListaCircularOrdenada<X> model) throws Exception {
        if (model == null)
            throw new Exception("Modelo Ausente");
    ...
    public Object clone() {
        ListaCircularOrdenada ret = null;
        try {
            ret = new ListaCircularOrdenada(this);
